...
<div class="relative">
  ...
  <div
    class="fixed top-0 left-0 z-60 h-screen w-64 flex flex-col justify-between bg-white border-r overflow-y-auto transition-transform duration-300 ease-in-out {isOpen
      ? 'translate-x-0'
