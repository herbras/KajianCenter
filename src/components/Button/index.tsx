...
const FamilyButton: React.FC<FamilyButtonProps> = ({ children }) => {
  ...
  return (
    <div
      className={cn(
        "rounded-[24px] border font-pally border-black/10 shadow-sm dark:border-teal-700/20",
        "bg-gradient-to-b from-teal-300 to-teal-700",
        isExpanded
          ? "w-[354px] bg-gradient-to-b dark:from-teal-800 dark:to-teal-700/80"
          : "dark:from-teal-900 dark:to-teal-950 bg-gradient-to-b"
      )}
    >
  ...
  return (
    ...
    >
      ...
      >
        {isExpanded ? (
          <motion.div
            className="p-[10px] group bg-neutral-800/50 dark:bg-black/50 border border-cyan-100/30 hover:border-neutral-200 text-orange-50 rounded-full shadow-2xl transition-colors duration-300 flex items-center justify-center"
          ...
          <motion.div
            className={cn(
              "p-[10px] group bg-neutral-200 dark:bg-cyan-500/90 text-cyan-50 border border-cyan-100/10  shadow-2xl transition-colors duration-200 flex items-center justify-center"
            )}
